    ...
    (define (run-generator colors)
      (if (procedure? generator)
          ...
          (farg-theme
           ...
           (accent-0 (assoc-ref colors 1))
           (accent-1 (assoc-ref colors 2))
           (accent-2 (assoc-ref colors 3))
           (accent-3 (assoc-ref colors 4))
           (accent-4 (assoc-ref colors 5))
           (accent-5 (assoc-ref colors 6))
           (accent-6 (assoc-ref colors 7))
           (accent-7 (assoc-ref colors 8))
           (alpha alpha)
           (light? light?)
           (wallpaper wallpaper)
           (other colors))))
